    ...
    <div class="max-w-7xl mx-auto px-6 py-4">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 bg-linear-to-br from-blue-500 to-cyan-400 rounded-lg flex items-center justify-center">
            ...
            <div class="hidden md:flex items-center gap-8">
                <a href="{{ route('solutions') }}" class="text-gray-700 hover:text-blue-600 font-medium transition">Solutions</a>
                <a href="{{ route('programs') }}" class="text-gray-700 hover:text-blue-600 font-medium transition">Programs</a>
                <a href="{{ route('vision') }}" class="text-gray-700 hover:text-blue-600 font-medium transition">Vision</a>
                <a href="{{ route('shop') }}" class="text-gray-700 hover:text-blue-600 font-medium transition">Shop</a>
                <a href="{{ route('blogs') }}" class="text-gray-700 hover:text-blue-600 font-medium transition">Blogs</a>
                <a href="#contact" class="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition">Get Started</a>
            </div>
